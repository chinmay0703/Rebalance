            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-lg-0 p-2">
                  ...
                  <li class="nav-item">
                    <Link class="nav-link mx-1" aria-current="page" to="/gallery"><h6 class="nav-text" >Gallery</h6></Link>
                  </li>
                  <li class="nav-item">
                    <Link class="nav-link mx-1" aria-current="page" to="/aboutus" onClick={scrollToTop}><h6 class="nav-text" style={{ color: '#039dfc' }}>AboutUs</h6></Link>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item" onClick={scrollToContact}>
                    <Link to="#" class="nav-link mx-1"><h6 class="nav-text">Contact Us</h6></Link>
                  </li>
                </ul>
              </div>
